    ...
    <div className="bg-slate-50">
      <section>
        ...
        sm:pb-32 lg:gap-x-0 xl:gap-x-8 lg:pt-24 xl:pt-32 lg:pb-52">
          <div className="col-span-2 px-6 lg:px-0 lg:pt-4">
            ...
            lg:items-start">
              <div className="absolute w-28 left-0 -top-20 hidden lg:block">
                <img src="./logo cutiestuff.png" alt="" className="w-full mb-10 h-full" />
              </div>
              ...
              sm:items-start gap-5">
                <div className="flex -space-x-4">
                  ...
                  ring-slate-100" src="/users/user-1.png" alt="user image" />
                  <img className="inline-block h-10 w-10 rounded-full ring-2
                  ring-slate-100" src="/users/user-2.png" alt="user image" />
                  <img className="inline-block h-10 w-10 rounded-full ring-2
                  ring-slate-100" src="/users/user-3.png" alt="user image" />
                  <img className="inline-block h-10 w-10 rounded-full ring-2
                  ring-slate-100" src="/users/user-4.jpg" alt="user image" />
                  <img className="inline-block h-10 w-10 rounded-full ring-2
                  ring-slate-100 object-cover" src="/users/user-5.jpg" alt="user image" />
                </div>
          ...
          <div className="cols-span-4 lg:col-span-1 w-full flex justify-center 
          px-8 sm:px-16 md:px-0 mt-32 lg:mx-0 lg:mt-20 h-fit">
            <div className="relative md:max-w-xl">
              ...
              selec-none hidden sm:block lg:hidden xl:hidden 2xl:block"/>
              <img src="/line.png" alt="" className="absolute w-20 -left-6 -bottom-6 select-none" />
              <Phone className="w-64" imgSrc="https://thriftymommaramblings.com/wp-content/uploads/2017/08/pets-for-kids-.jpg" />
            </div>
          </div>
        </MaxWidthWrapper>
      </section>
      ...
      <section className='bg-slate-100 grainy-dark py-24'>
        <MaxWidthWrapper className='flex flex-col items-center gap-16 sm:gap-32'>
          <div className='flex flex-col lg:flex-row items-center gap-4 sm:gap-6'>
            ...
            <img src='https://img.freepik.com/premium-psd/3d-rendering-pink-alphabet-c-letter-creative-premium-psd-premium-psd_515994-3.jpg' className='w-24 order-0 lg:order-2 rounded-xl' />
          </div>
          ...
          <div className='mx-auto grid max-w-2xl grid-cols-1 px-4 lg:mx-0 lg:max-w-none lg:grid-cols-2 gap-y-16'>
            ...
            <div className='flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20'>
              ...
              <div className='flex gap-4 mt-2'>
                ...
                />
                <div className='flex flex-col'>
                  <p className='font-semibold'>Raihan</p>
                  <div className='flex gap-1.5 items-center text-zinc-600'>
                    <Check className='h-4 w-4 stroke-[3px] text-green-600' />
                    <p className='text-sm'>Verified Purchase</p>
                  </div>
        ...
        <MaxWidthWrapper className="py-24">
          <div className="mb-12 px-6 lg:px-8">
            <div className="mx-auto max-w-2xl sm:text-center">
              <h2 className='order-1 mt-2 tracking-tight text-center text-balance !leading-tight font-bold text-5xl md:text-6xl text-gray-900'>
                ...
                <span className='relative px-2 bg-pink-400 rounded-md text-white'>
                  your own case
                </span>{' '}
                now
              </h2>
          ...
          <div className="mx-auto max-w-6xl px-6 lg:px-8">
            <div className="relative flex flex-col items-center md:grid grid-cols-2 gap-40">
              ...
              <div className="relative h-80 md:h-full w-full md:justify-self-end max-w-sm rounded-xl bg-gray-900/5 ring-inset ring-gray-900/10 lg:rounded-2xl">
                <img src="/horse.jpg" alt="" className="rounded-md object-cover bg-white shadow-2xl ring-1 ring-pink-900/10 h-full w-full" />
              </div>
          ...
          <ul className="mx-auto mt-12 max-w-prose sm:text-lg space-y-2 w-fit">
            ...
            <div className="flex justify-center">
              {isLoading ? (
                <Button className="px-4 sm:px-6 lg:px-8 cursor-not-allowed" disabled>
                  Please Wait...
                </Button>
              ) : (
                <Link onClick={() => handleLoading()} className={buttonVariants({
                  size: "lg",
