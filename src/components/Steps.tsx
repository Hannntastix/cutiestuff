...
const Steps = () => {
    ...
    return <ol className="rounded-md bg-white lg:flex lg:rounded-none lg:border-l lg:border-r lg:border-gray-200">
        {STEPS.map((step, i) => {
            ...
            const imgPath = 'https://pngimg.com/uploads/dot/dot_PNG35.png'
            ...
            return <li key={step.name} className="relative overflow-hidden lg:flex-1">
                <div>
                    ...
                    <span className={cn(i !== 0 ? 'lg:pl-9' : '', "flex items-center px-6 py-4 text-sm font-medium border-b-4")}>
                        ...
                        <span className="ml-4 h-full mt-0.5 flex lg:flex-row flex-col min-w-0 f;ex-col justify-center">
